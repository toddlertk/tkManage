...
/**
 * MsgEventClick entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "msg_event_click")
public class MsgEventClick implements java.io.Serializable {
	...
	/** default constructor */
	public MsgEventClick() {
		this.tableMsgId = UUID.randomUUID().toString().replace("-", "");
	}

	/** minimal constructor */
	public MsgEventClick(String tableMsgId, String toUserName,
